...
p2 <- ggplot(surv_diff2) + 
  ...
  geom_ribbon(aes(x = 1:365, 
                  ymin= 2*Total_effect - quant_te[,2], 
                  ymax= 2*Total_effect - quant_te[,1]), alpha=0.2) + 
...
p3 <- ggplot(surv_diff3) + 
  ...
  geom_ribbon(aes(x = 1:365, 
                  ymin=  2*AW_component - quant_se1[,2], 
                  ymax=  2*AW_component - quant_se1[,1]), alpha=0.2) + 
  geom_hline(yintercept = 0, linetype = "dashed", size = 1) 
...
p4 <- ggplot(surv_diff4) + 
  ...
  geom_ribbon(aes(x = 1:365, 
                  ymin= 2*Mix_AGAW - quant_se2[,2], 
                  ymax= 2*Mix_AGAW - quant_se2[,1]), alpha=0.2) + 
  geom_hline(yintercept = 0, linetype = "dashed", size = 1)
