...
p2 <- ggplot(CIF_diff2) + 
  ...
  geom_ribbon(aes(x = 1:365, 
                  ymin= 2*Total_effect - quant_teG[,2], 
                  ymax= 2*Total_effect - quant_teG[,1]), alpha=0.2) + 
...
p3 <- ggplot(CIF_diff3) + 
  ...
  geom_ribbon(aes(x = 1:365, 
                  ymin= 2*AW_component - quant_se1G[,2], 
                  ymax= 2*AW_component - quant_se1G[,1]), alpha=0.2) + 
  geom_hline(yintercept = 0, linetype = "dashed", size = 1) 
...
p4 <- ggplot(CIF_diff4) + 
  ...
  geom_ribbon(aes(x = 1:365, 
                  ymin= 2*Mix_AGAW - quant_se2G[,2], 
                  ymax= 2*Mix_AGAW - quant_se2G[,1]), alpha=0.2) + 
  geom_hline(yintercept = 0, linetype = "dashed", size = 1)
